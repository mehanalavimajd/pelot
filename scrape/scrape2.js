...
let districts = [
  ...
  "chitgar",
  "gomrok",
  "mobarak-abad-e-beheshti",
  "marzdaran",
  "shahrak-naft-district5",
  "shamshiri",
  "ostad-moein",
  "sharara",
  "niavaran",
...
axios.default
  .post("https://api.divar.ir/v8/postlist/w/search", {
    ...
    pagination_data: {
      ...
      last_post_date: "2024-07-14T16:31:55.336631Z",
      page: i,
      layer_page: i,
    },
    search_data: {
  ...
  .then((response) => {
    ...
    let tokens = data["list_widgets"];
    for (let index = 0; index < tokens.length; index++) {
      let t = tokens[index]['data']['action']['payload'];
      let token = t["token"];
